...
public class GtAISProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public GtAISProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
