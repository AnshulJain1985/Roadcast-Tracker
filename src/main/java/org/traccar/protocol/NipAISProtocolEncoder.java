...
public class NipAISProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public NipAISProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
