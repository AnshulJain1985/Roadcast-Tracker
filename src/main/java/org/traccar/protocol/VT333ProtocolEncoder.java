...
public class VT333ProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public VT333ProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
