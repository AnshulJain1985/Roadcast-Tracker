...
public class RoadcastProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public RoadcastProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
