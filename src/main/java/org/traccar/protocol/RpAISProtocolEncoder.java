...
public class RpAISProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public RpAISProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
