...
public class SiwiProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public SiwiProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
    ...
    protected Object encodeCommand(Command command) {
        ...
        switch (command.getType()) {
            case Command.TYPE_ENGINE_STOP:
                return formatCommand(command, "stopv");
            case Command.TYPE_ENGINE_RESUME:
                return formatCommand(command, "startv");
