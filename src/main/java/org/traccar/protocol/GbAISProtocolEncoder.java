...
public class GbAISProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {

    public GbAISProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
