...
public class GElockProtocolDecoder extends BaseProtocolDecoder {

    public GElockProtocolDecoder(GElockProtocol protocol) {
        super(protocol);
    }
    ...
    protected Object decode(
        ...
        if (deviceSession.getTimeZone() == null) {
            deviceSession.setTimeZone(getTimeZone(deviceSession.getDeviceId(), "GMT+0"));
        }
