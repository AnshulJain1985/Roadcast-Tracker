...
public class GbAISProtocolDecoder extends BaseProtocolDecoder {

    private static final Logger LOGGER = LoggerFactory.getLogger(GbAISProtocolDecoder.class);

    public GbAISProtocolDecoder(GbAISProtocol protocol) {
        super(protocol);
    }
...
//        String checksum = parser.next();
    ...
    protected Object decode(Channel channel, SocketAddress remoteAddress, Object msg) throws Exception {
        ...
        LOGGER.info(channel.id().asShortText() + " - GBAIS String: " + sentence);


        Parser parser = new Parser(PATTERN_LOGIN, sentence);
        if (parser.matches()) {
            channel.writeAndFlush(new NetworkMessage("+##Received OK", remoteAddress));
