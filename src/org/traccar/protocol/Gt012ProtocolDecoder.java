...
public class Gt012ProtocolDecoder extends BaseProtocolDecoder {

    private final Map<Integer, ChannelBuffer> photos = new HashMap<>();

    public Gt012ProtocolDecoder(Gt012Protocol protocol) {
        super(protocol);
    }
    ...
    protected Object decode(
        ...
        Log.info("GT012 HEX: " + ChannelBuffers.hexDump(buf));
