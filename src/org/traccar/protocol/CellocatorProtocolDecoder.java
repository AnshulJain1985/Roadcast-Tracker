...
//        if (hardwareVersion == 235 || hardwareVersion == 225 || hardwareVersion == 43
//                || hardwareVersion == 75 || hardwareVersion == 107 || hardwareVersion == 139) {
//            position.set(Position.KEY_DOOR, BitUtil.check(input, 0));
