...
public class Gt012ProtocolEncoder extends BaseProtocolEncoder {

    private ChannelBuffer encodeContent(long deviceId, String content) {

        boolean language = Context.getIdentityManager().lookupAttributeBoolean(deviceId, "gt012.language", false, true);
    ...
    protected Object encodeCommand(Command command) {
        ...
        boolean alternative = Context.getIdentityManager().lookupAttributeBoolean(
                command.getDeviceId(), "gt012.alternative", false, true);
