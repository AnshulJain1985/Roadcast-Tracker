...
public class AtlAISProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {
    ...
    protected Object encodeCommand(Command command) {
        ...
        switch (command.getType()) {
            case Command.TYPE_CUSTOM:
                return formatCommand(command, "$MSG,{%s}&", Command.KEY_DATA);
            default:
