...
public class EelinkAssetProtocolDecoder extends BaseProtocolDecoder {

    public EelinkAssetProtocolDecoder(Protocol protocol) {
        super(protocol);
    }
    ...
    private void sendResponse(Channel channel, SocketAddress remoteAddress, String uniqueId, int type, int index) {
        if (channel != null) {
            channel.writeAndFlush(new NetworkMessage(EelinkAssetProtocolEncoder.encodeContent(
