...
public class Eg02ProtocolEncoder extends BaseProtocolEncoder {
    ...
    protected Object encodeCommand(Command command) {
        ...
        switch (command.getType()) {
            case Command.TYPE_ENGINE_STOP:
                return encodeContent(command.getDeviceId(), "StarACC,ON#");
            case Command.TYPE_ENGINE_RESUME:
                return encodeContent(command.getDeviceId(), "StarACC,OFF#");
